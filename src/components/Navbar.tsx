...
interface NavbarProps {
    headerTitle: string
    searchBarOnChange?: ChangeEventHandler<HTMLInputElement>
...
export default function Navbar(
    ...
    return (
        <nav className='h-14  flex flex-row justify-between px-10 border border-gray-200 bg-white sticky top-12'>
            ...
            <div className='h-full w-auto min-w-[20rem] flex flex-row py-2'>
                <div className="flex justify-center flex-1 bg-transparent mr-2">
                    <input
                        ...
                        type={`text`}
                        className={`outline-hidden border border-zinc-200 bg-transparent flex-1 px-3 transition-all 
