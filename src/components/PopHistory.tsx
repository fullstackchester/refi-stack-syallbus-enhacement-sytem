...
interface PopHistoryProps extends PropsWithChildren {
    isOpen: boolean
    handleClose: () => void
    title?: ReactNode
}
...
export default function PopHistory(
    { isOpen, handleClose, title, children }: PopHistoryProps
) {
    return (
        <>
                                ...
                                <div className="mt-4 flex justify-end">
                                    <button
                                        ...
                                        className="inline-flex justify-center px-4 py-2 text-sm font-medium text-blue-900
                                         bg-blue-100 border border-transparent rounded-md hover:bg-blue-200 focus:outline-hidden
